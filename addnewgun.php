  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
	      <p class="style3">Craft a GUN!</p>
<p>You can add a new gun in this section. <br>
            <br>
...
$sqlSailors = "SELECT R.rName, M.resource_rID
				FROM Mineral M, Resource R
				WHERE R.rID = M.resource_rID
				 ORDER BY rID";
...
$sqlCount = 'SELECT MAX(G.gID) as maxGid FROM Gun G';
$resultCount = mysqli_query($db, $sqlCount);
$rowCount = mysqli_fetch_assoc($resultCount);
$mypid = $rowCount['maxGid'];
...
?>
 ...
 <form action="addnewgun.php" method="post">
          <table width="415" height="140" border="1" bordercolor="#003333">

            <tr>
              <td width="121" height="26"><div align="center">Gun Name: </div></td>
            ...
            <tr>
              <td width="121" height="26"><div align="center">Date of Production: </div></td>
              <td width="278"><div align="center">
                <input type="text" name="date" size="36">
              </div></td>
            </tr>
            ...
            <tr>
              <td height="26"><div align="center">Made of</div></td>
              <td><div align="center">
                <select name="house">
        ...
        ?>
            ...
            <tr>
              <td height="26"><div align="center">Belongs to:</div></td>
              <td><div align="center">
                <select name="owner">
        ...
        ?>
            ...
            <tr bordercolor="#454A61">
              ...
              <td>
                <div align="center">
                  <input name="submit" type="submit" value="Craft a New Gun !!!!">
                  </div></td></tr>
          </table>
...
if(isset($_POST['personname'])  && isset($_POST['date']))
...
$personquery = "INSERT INTO Gun (gID, gName, belongs_to)
VALUES ('$pID', '$pName' , '$owned');";

$madequery = "INSERT INTO made_of(pDate, rID, gID )
VALUES ('$date' ,'$loc', '$pID');";

$presult = mysqli_query($db, $personquery);
$made = mysqli_query($db, $madequery);
$sresult = 0;
$wresult = 0;
		...
		echo "<font color = 'green'>The gun has been added successfully.</font>";
		}
		
		else 
		{
		echo "<font color = 'red'>The gun could not be added.</font>";
		}
