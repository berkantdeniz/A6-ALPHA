  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
	  ...
	  <td width="301" bgcolor="#040D1B" border=""  bordercolor="38394F" ><table width="276" height="389" border="1" align="center" bordercolor="#556B2F">
        ...
        <tr>
          <td><a href="planetinfo.php"><img src="images/icons.png" width="15" height="15" border="0"/> MOST CROWDED PLANET </a></td>
        </tr>
      </table>
	    <p>&nbsp;</p>
	    <p>&nbsp;</p></td>
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">Planet Name</th>
              <th width="264" bgcolor="#333333" class="style8">Member count</th>
...
$sql = 'SELECT T.pID, T.pName, COUNT(*) AS population
FROM (SELECT A.aID, P.pID, P.pName
	  FROM Planet P, Alien A
	  WHERE A.comes_from = P.pID) AS T
GROUP BY T.pID
HAVING COUNT(*) >= ALL (SELECT COUNT(*)
                       	FROM Alien A
                       	GROUP BY A.comes_from)';
...
$sqlCount = 'SELECT COUNT(*) as count FROM Nutrition';
...
$count = $rowCount['count'];
 ...
 <?php
    ...
    echo "<tr>
          <td><center><font color='#7FDBFF'>$name</font></center></td>
          <td><center><font color='#B10DC9'>$pop</font></center></td>
