	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          ...
          <th width="264" bgcolor="#333333" class="style8">Land Name</th>
              <th width="264" bgcolor="#333333" class="style8">Owner</th>
                  <th width="264" bgcolor="#333333" class="style8">Location</th>
                  <th width="264" bgcolor="#333333" class="style8"> in (Planet)</th>
...
$sql = 'SELECT L.lName, A.aName, L.location, P.pName
        FROM Land L, Planet P, Alien A
        WHERE L.owned_by = A.aID AND P.pID = L.located';
...
$count = $rowCount['count'];
 ...
 <?php
    ...
    echo "<tr>
          ...
          <td><center><font color='#3D9970'>$loc</font></center></td>
          <td><center><font color='#7FDBFF'>$pname</font></center></td>
