	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">Alien Name</th>
              <th width="264" bgcolor="#333333" class="style8">Worker Speciality</th>
...
$sql = 'SELECT A.aName, W.speciality, P.pName
        FROM Planet P, Worker W, Alien A
        WHERE A.aID = W.alien_aID AND A.comes_from = P.pID';
 ...
 <?php
    ...
    echo "<tr>
          <td><center><font color='#01FF70'>$name</font></center></td>
             <td><center><font color='#FF851B'>$type</font></center></td>
          <td><center><font color='#7FDBFF'>$planet</font></center></td>
