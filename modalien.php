  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
	      <p class="style3">UPDATE NAME </p>
	      <p>You can modify an alien's name in this section <br>
            <br>
...
?>
 ...
 <form action="modalien.php" method="post">
          <table width="415" height="140" border="1" bordercolor="#003333">
            ...
            <tr>
              <td width="200" height="26"><div align="center">New Name: </div></td>
...
<tr>
              <td height="26" ><div align="center">Alien name to Modify</div></td>
              <td width="180" ><div align="center">
                <select name="house">
...
$presult1 = mysqli_query($db, $sql1);
		...
		if(($presult1 ))
		{
		echo "<font color = 'green'>The alien name  has been changed successfully.</font>";
		}
		
		else 
		{
		echo "<font color = 'red'>The alien name not be changed.</font>";
		}
