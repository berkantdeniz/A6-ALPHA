  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<p>&nbsp;</p>
	    <p align="center" class="style3">Welcome to A6-ALPHA SPACE STATION DB </p>
	    ...
	    <p align="center" class="style2">This site is used for managing A6-ALPHA</p>
	    <p align="center" class="style2">You are the admin of the space station</p>
	    <p align="center" class="style2">You are responsible for the log entries</p>
	    <p align="center" class="style2">Do not forget to specify every action </p>
	    <p align="center" class="style2"></p>
	    <p align="center">
		  <!-- END OF THE PHP CODE  -->		
	      <a href="index.php"><img src="images/alien_logo.png" width="168" height="166" border="0"/></a></p>
	    </td>
