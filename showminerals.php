	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          ...
          <th width="264" bgcolor="#333333" class="style8">Resource Name</th>
              <th width="264" bgcolor="#333333" class="style8">Rareness</th>
...
$sql = 'SELECT R.rNAME, M.rareness, L.lName
        FROM Resource R, Mineral M, Land L, yield Y
        WHERE R.rID = Y.rID AND Y.lID = L.lID AND M.resource_rID = R.rID ';



$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM Mineral';
...
$count = $rowCount['count'];
 ...
 <?php
    ...
    $name = $row['rNAME'];
    $rarenes = $row['rareness'];
    $lname = $row['lName'];
  
	
    echo "<tr>
          <td><center><font color='#FFDC00'>$name</font></center></td>
          <td><center><font color='#FF851B'>$rarenes</font></center></td>
