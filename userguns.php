	  ...
	  <td width="1115"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">Gun Name</th>
              <th width="264" bgcolor="#333333" class="style8">Belongs to</th>
                  <th width="264" bgcolor="#333333" class="style8">Made of</th>
                  <th width="264" bgcolor="#333333" class="style8">Date of production</th>
...
$sql = 'SELECT G.gName, A.aName, R.rName, M.pDate
        FROM Gun G, made_of M, Resource R, Alien A, Mineral Mi
        WHERE A.aID = G.belongs_to AND G.gID = M.gID AND M.rID = Mi.resource_rID AND Mi.resource_rID = R.rID';
...
$count = $rowCount['count'];
 ...
 <?php
    ...
    echo "<tr>
          <td><center><font color='#FF4136'>$gname</font></center></td>
             <td><center><font color='#01FF70'>$name</font></center></td>
          <td><center><font color='#FFDC00'>$rname</font></center></td>
          <td><center><font color='#86144b'>$pdate</font></center></td>
