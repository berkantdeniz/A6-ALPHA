	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          ...
          <th width="264" bgcolor="#333333" class="style8">Alien Name</th>
              <th width="264" bgcolor="#333333" class="style8">Soldier Type</th>
...
$sql = 'SELECT A.aName, S.type, P.pName
        FROM Planet P, Soldier S, Alien A
        WHERE A.aID = S.alien_aID AND A.comes_from = P.pID';
