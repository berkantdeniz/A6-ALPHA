	  ...
	  <td width="814"  bordercolor="000000" bgcolor="071227" border="1" >
		...
		<div align="center">
          ...
          <th width="264" bgcolor="#333333" class="style8">Resource Name</th>
              <th width="264" bgcolor="#333333" class="style8">Quality</th>
...
$sql = 'SELECT R.rNAME, N.quality, L.lName
        FROM Resource R, Nutrition N, Land L, yield Y
        WHERE R.rID = Y.rID AND Y.lID = L.lID AND N.resource_rID = R.rID ';
